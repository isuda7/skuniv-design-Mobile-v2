...
// 학습창
import LearningConponents from './views/Learning/LearningComponents'
...
import LearningOverviewCurriculum from './views/Learning/LearningOverviewCurriculum'
        ...
        <HashRouter>
            <Routes>
                ...
                <Route path='/' element={<LayoutSub />}>
                    ...
                    {/* Learning */}
                    <Route path='/Learning/LearningConponents' element={<LearningConponents />} />
                    ...
                    <Route path='/Learning/LearningOverviewCurriculum' element={<LearningOverviewCurriculum />} />
                </Route>
            </Routes>
        </HashRouter>
    )
